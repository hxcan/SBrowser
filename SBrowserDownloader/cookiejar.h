...
QT_FORWARD_DECLARE_CLASS(CookieExceptionsModel)

//#include "CookieExceptionsModel.h" //CookieExceptionsModel
...
private:
    QVariant getDisplayOrEditRoleData(const QModelIndex &index, QList<QNetworkCookie> lst) const; //!<返回显示或编辑角色数据。
