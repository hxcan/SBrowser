 ...
 */
void SbTtsClient::setServerAddress(QString ttsServerAddress2St)
{
 ...
 */
void SbTtsClient::setServerPort(quint16 ttsServerPort2St)
{
 ...
 */
void SbTtsClient::startConnectTtsServer()
{
...
/*!
 * \brief SbTtsClient::~SbTtsClient 析构函数。
 */
SbTtsClient::~SbTtsClient()
{
 ...
 */
void SbTtsClient::saySentence(QString trLoadfinished)
{
 ...
 */
void SbTtsClient::connectSignals()
{
 ...
 */
void SbTtsClient::sendTtsCommand()
{
